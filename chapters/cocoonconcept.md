...
The rest of this document is a specification for what that careful design looks like in practice.

---

*Note, HC: This chapter should remain under continuous revision as the philosophical literature develops and as the experimental results of early Cocoon prototypes accumulate. The operational definition in Section 5 is especially likely to require refinement once we have observable data from embodied systems to reason about.*
...
![The Humanoid Cage](chapter7_img1.png)
...
![The Native Vector Space](chapter7_img2.png)
...
![The Transition from Stateless Transaction to Continuous Intelligence](chapter9_img1.png)
